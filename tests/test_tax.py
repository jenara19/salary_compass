...
class TestReturnStructure:
    def test_required_keys(self):
        ...
        for key in ("gross_annual", "net_monthly_local", "net_monthly_eur",
...
class TestCountrySanity:
    ...
    @pytest.mark.parametrize("gross,country,lo_pct,hi_pct", [
        (57500,  "ES",  20, 40),
        (80000,  "NL",  25, 45),
        (85000,  "NL",  25, 45),
        (80000,  "DE",  30, 50),
    ...
    @pytest.mark.parametrize("gross,country", [
        (57500,  "ES"), (85000, "NL"), (80000, "DE"),
        (120000, "CH"), (700000, "NOR"), (60000, "UK"),
    ])
...
class TestGenevaTax:
    ...
    @pytest.mark.parametrize("gross,expected,tol", [
        (120000, 7435,  75),
        (130000, 8010,  75),
        (80000,  5116,  75),
    ])
    ...
    def test_geneva_higher_gross_gives_higher_net(self):
        ...
        nets = [calculate_net(g, "GE")["net_monthly_local"]
...
class TestBeckhamLaw:
    ...
    def test_beckham_material_at_120k(self):
        ...
        assert saving > 600, (
            f"Beckham should save >€600/mo at €120k, got +€{saving}/mo"
        )
    ...
    def test_beckham_scheme_in_es_yaml(self):
        ...
        from engine.tax import load_country, get_schemes
    ...
    def test_beckham_returns_correct_structure(self):
        ...
        for key in ("gross_annual", "net_monthly_eur", "effective_rate", "currency", "eur_rate"):
...
class TestNLTaxCredits2026:
    ...
    def test_ahk_zero_above_78426(self):
        ...
        credit_cfg = {
            "max_credit": 3115, "phase_out_start": 29736,
            "phase_out_end": 78426, "phase_out_rate": 0.06398,
        }
...
class TestNL30to27RulingRateChange:
    ...
    def test_scheme_overrides_reduces_net(self):
        ...
        net_27 = calculate_net(85000, "NL", ["nl_30_ruling"],
                               scheme_overrides={"nl_30_ruling": {"multiplier": 0.73}})["net_monthly_eur"]
    ...
    def test_scheme_overrides_backwards_compatible(self):
        ...
        net_b = calculate_net(85000, "NL", ["nl_30_ruling"], scheme_overrides=None)["net_monthly_eur"]
        assert net_a == net_b
    ...
    def test_find_target_gross_with_scheme_overrides(self):
        ...
        check = calculate_net(gross_needed, "NL", ["nl_30_ruling"],
                              scheme_overrides={"nl_30_ruling": {"multiplier": 0.73}})
